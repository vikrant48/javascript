...
console.log(myarr2) 
myarr2.shift()//delete first element 
console.log(myarr2)
...
const count = myarr4.push(myarr5) // count have no of element becoz array ke sath func hai and myarr4 have all data
console.log(count)
...
console.log(Array.from({name: "vikrant"})) // **  give []  becaouse its object but we can make array of there key or value 
